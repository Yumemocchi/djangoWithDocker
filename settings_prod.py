...
TEMPLATES = [
    {
        ...
        # Pour accéder au fichier templates src
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'myblog.context_processors.cat_list_view',
            ],
        },
    },
]
...
# Les répertoires habituels de chaque application
STATIC_URL = '/static/'
MEDIA_URL = '/media/'
...
# Chemin absolu de système de fichiers pointant vers le répertoire
